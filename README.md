...
Brute force method for breaking 66+ bit keys is very time and power consumming, keep in mind even if the reward for breaking a key is around $300,000 (with a $40,000 BTC) it can be not profitable in area where the electricity cost is very expensive.  
